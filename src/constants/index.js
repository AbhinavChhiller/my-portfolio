...
const projects = [
  ...
  },
  {
    name: "FitZone",
    description:
      "A website for Fitzone gym showcasing details about the gym, trainers, and programs with an option to switch between light and dark modes, built with React and Tailwind CSS.",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
    ...
    image: fit_zone,
    source_code_link: "https://github.com/AbhinavChhiller/Gym-website",
    live_demo_link:
      "https://gym-website-1ggn3h7zx-abhinavchhillers-projects.vercel.app/",
  },
  {
    name: "EasyCaptcha",
    description:
      "A lightweight, backend-free React captcha component published on npm. It renders captchas on a canvas, provides client-side validation utilities, and is customizable for length, dimensions, and click-to-refresh.",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
    ...
    image: easy_captcha,
    source_code_link: "https://github.com/AbhinavChhiller/npm-captcha",
    live_demo_link:
      "https://www.npmjs.com/package/easy-captcha-react-js",
  },
   {
    name: "Jesko Jets",
    description:
      "A fully animated 3D parallax website for Jesko Jets, built with React, Framer Motion, and Lenis for smooth scroll-driven animation and immersive interactions.",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
    ...
    image: jesko_jets,
    source_code_link: "https://github.com/AbhinavChhiller/Parallax",
    live_demo_link:
      "https://parallax-omega-one.vercel.app/",
  },
];
